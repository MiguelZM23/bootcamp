...
class RentalResourceTest {
	...
	void setUp() throws Exception {
		...
		listado.add(new RentalEditDTO(1, new Date(), new Date(),1, 1, 1,   List.of(new PaymentEditDTO(0, 0, null, null))));
		listado.add(new RentalEditDTO(2,  new Date(), new Date(),2, 2, 2, List.of(new PaymentEditDTO(1, 1, null, null))));
	}
	...
	class PruebasUnitarias {
		...
		void testUpdateInvalidData() throws NotFoundException, InvalidDataException {
			assertThrows(InvalidDataException.class, () -> rest.update(1, new RentalEditDTO(2, new Date(), new Date(), 2, 2, 2,  null)));
		}
