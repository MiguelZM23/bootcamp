...
/**
 * @author mizapata Adivina el número version: 0.1
 *
 */
public class main {
	...
	public static void main(String[] args) {
		/*
		 * // Ejercicio 1: Adivina el número var rnd = new Random(); int num = (int)
		 ...
		 * solución para cerrar teclado. Scanner teclado = null;
		 * 
		 ...
		 * 
		 * if (cad2 > num) System.out.println("Prueba con un número menor"); else
